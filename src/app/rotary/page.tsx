...
export default function RotaryPartnershipPage() {
  ...
  // Calculate projected impacts dynamically without clutter
  ...
  return (
    <div className="min-h-screen bg-[#061128] text-slate-100 selection:bg-[#F7A81B] selection:text-[#00246C]">
      
      {/* ─────────────────────────────────────────────────────────────
          1. TOP NOTIFICATION BAR (Rotary Core Strategic Alignment)
          ───────────────────────────────────────────────────────────── */}
      <div className="bg-gradient-to-r from-[#00246C] via-[#0C3C7C] to-[#00246C] border-b border-[#F7A81B]/40 py-2.5 px-4 text-center text-xs sm:text-sm text-amber-200 flex items-center justify-center gap-2">
      ...
      <section className="relative pt-14 pb-20 sm:pt-20 sm:pb-28 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[700px] h-[700px] bg-[#00246C]/40 rounded-full blur-[140px] pointer-events-none" />
        <div className="absolute top-1/3 right-10 w-96 h-96 bg-[#F7A81B]/15 rounded-full blur-[110px] pointer-events-none" />
        <div className="absolute bottom-10 left-10 w-80 h-80 bg-teal-500/10 rounded-full blur-[100px] pointer-events-none" />

        {/* Delicate Cyber/Starlight Grid */}
        <div
        ...
        <div className="max-w-6xl mx-auto relative z-10 text-center space-y-8">
          ...
          <div className="inline-flex items-center justify-center gap-3 sm:gap-6 px-6 py-3 rounded-full bg-white/10 backdrop-blur-md border border-[#F7A81B]/50 shadow-2xl shadow-black/50 animate-fade-in">
            <div className="flex items-center gap-2.5 text-[#F7A81B]">
              <RotaryWheel className="w-8 h-8 sm:w-9 sm:h-9" />
            ...
            <div className="flex items-center gap-2.5 text-left">
              <div className="w-8 h-8 rounded-full bg-white/15 p-1 overflow-hidden shadow-inner">
                <Image
              ...
              <div>
                <span className="font-extrabold text-xs sm:text-sm text-cyan-300 block leading-none">
                  DijitalBüyükanne
                </span>
                <span className="text-[9px] text-slate-300 font-mono tracking-widest">BEBEK SAĞLIĞI AI</span>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-4xl mx-auto pt-6 text-left">
            <div className="p-4 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[11px] text-slate-300">Mobil uygulamada ve sertifikalarda kalıcı kulüp ambleminiz</p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[11px] text-slate-300">0–6 ay nöromotor tarama ile ömür boyu engellilik riskini önleyin</p>
              </div>
            </div>
      ...
      {/* ─────────────────────────────────────────────────────────────
          ...
          ───────────────────────────────────────────────────────────── */}
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-[#001B52] via-[#0C2A6B] to-[#001B52] border-y border-[#F7A81B]/30 relative">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          
          <div className="md:col-span-8 space-y-4">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#F7A81B]/20 text-[#F7A81B] text-xs font-black uppercase tracking-widest">
              <Compass size={14} />
          ...
          <div className="md:col-span-4 flex justify-center">
            <div className="p-6 rounded-3xl bg-white/10 border border-white/20 backdrop-blur-md text-center space-y-3 shadow-xl">
              <div className="text-4xl sm:text-5xl font-black text-[#F7A81B] font-mono">
                0–6 Ay
              </div>
      ...
      {/* ─────────────────────────────────────────────────────────────
          ...
          ───────────────────────────────────────────────────────────── */}
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#050D20]">
      ...
      {/* ─────────────────────────────────────────────────────────────
          ...
          ───────────────────────────────────────────────────────────── */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-[#08183A] to-[#061128] border-y border-white/10 relative">
      ...
      {/* ─────────────────────────────────────────────────────────────
          ...
          ───────────────────────────────────────────────────────────── */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-[#050D20]">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 flex justify-center">
            <div className="relative w-full max-w-sm rounded-[42px] bg-gradient-to-b from-[#1E2554] to-[#0A1024] p-3 shadow-2xl border-4 border-[#F7A81B]/40 shadow-[#00246C]/60">
              {/* Screen Top Bar */}
              <div className="bg-[#00246C] rounded-[34px] p-4 text-white space-y-3 border border-white/10">
      ...
      {/* ─────────────────────────────────────────────────────────────
          ...
          ───────────────────────────────────────────────────────────── */}
      <section id="etki-hesaplayici" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-[#061128] via-[#0A1A40] to-[#061128] border-t border-white/10">
        <div className="max-w-5xl mx-auto space-y-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="p-6 rounded-3xl bg-white/5 border border-amber-400/40 text-center space-y-2 backdrop-blur-md relative overflow-hidden">
      ...
      {/* ─────────────────────────────────────────────────────────────
          ...
          ───────────────────────────────────────────────────────────── */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-[#050D20] border-t border-white/10">
        <div className="max-w-6xl mx-auto space-y-12">
      ...
      {/* ─────────────────────────────────────────────────────────────
          ...
          ───────────────────────────────────────────────────────────── */}
      <section id="rotary-basvuru" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-[#050D20] to-[#030814] border-t border-white/10">
      ...
      {/* ─────────────────────────────────────────────────────────────
          10. ROTARY FOOTER
          ───────────────────────────────────────────────────────────── */}
      <footer className="py-8 px-4 border-t border-white/10 bg-[#020610] text-center text-xs text-slate-400 space-y-2">
