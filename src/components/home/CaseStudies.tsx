...
const cases = [
  ...
  {
    category: 'Kritik Bebek Bezi Taraması',
    badge: 'Safra Yolu & Karaciğer',
    title: '22. Günde Yakalanan Biliyer Atrezi Şüphesi',
    babyAge: '22. Gün Taraması → 38. Günde Başarılı Cerrahi',
    color: 'border-coral/30',
    accentColor: 'text-coral',
    bgLight: 'from-coral/10',
    summary:
      'Emir bebeğin bezindeki soluk kilsi rengi tarayan yapay zekâ, aileyi acil çocuk cerrahisi yönlendirmesiyle uyardı.',
    journey: [
      '22. Gün: Anne bez fotoğrafını yükledi; sistem "Renk Kartı No. 1 - Akolik Şüphesi" alarmı verdi.',
      '23. Gün: Aile derhal üniversite hastanesi Çocuk Gastroenteroloji servisine başvurdu.',
      '38. Gün: Kasai operasyonu için kritik olan 60 günlük süreden önce ameliyat başarıyla yapıldı.',
      'Bugün: Emir 18 aylık, karaciğer fonksiyonları tamamen sağlıklı ve akranlarıyla büyüyor.',
    ],
    quote:
      'Biliyer atrezide her geçen gün karaciğer dokusu için hayati risk demektir. Bu erken yönlendirme Emir’in hayatını kurtardı.',
    author: 'Doç. Dr. M. Ç. (Çocuk Cerrahisi Uzmanı)',
    location: 'İstanbul',
  },
  {
